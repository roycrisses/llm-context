...
class TestTrimToBudget:
    ...
    def test_large_single_file_is_truncated_not_dropped(self):
        ...
        # budget - _OVERHEAD_TOKENS (512)
        # If we set max_tokens=200, budget becomes -312.
        # We need a higher max_tokens or smaller overhead in test.
        # Let's use 600 tokens budget.
