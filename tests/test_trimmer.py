...
class TestCountTokens:
    ...
    def test_empty_string_returns_zero(self):
        # Our implementation returns 0 for empty strings
...
class TestTrimToBudget:
    ...
    def test_large_single_file_is_truncated_not_dropped(self):
        ...
        # We need a bit more tokens for the overhead (fence + header)
        # _OVERHEAD_TOKENS is 512, so 600 should leave some room.
        result = trim_to_budget(files, model="gpt-4o", max_tokens=600)
